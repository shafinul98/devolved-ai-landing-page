  ...
  return (
    <main className="flex min-h-screen overflow-x-hidden flex-col items-center justify-between px-6 py-8 md:p-0">
        ...
        <div className="flex flex-col items-center justify-center md:flex-row md:justify-center md:p-12">
          <div className="text-center">
            ...
            <p className="font-ubuntu font-normal font-weight-400 text-[1rem] mb-6 md:mb-0 md:text-[1.25rem] text-[#495167]">
              Step into the future with Argocoin: The Cornerstone of Devolved
              AI. Anchored as <br />
              the native token on our Layer 1 blockchain, AGC isn’t just a
              digital currency – it's the <br />
        ...
        <div className="flex flex-col-reverse items-center lg:flex-row justify-around lg:px-4 xl:px-8 md:mx-16 lg:mb-20 relative">
          ...
          <div className="flex flex-col px-5 md:mt-10 gap-5 xl:ms-20">
            ...
            <h1 className="text-[2.75rem] text-[#192033] font-ubuntu font-black font-weight-700">
              <p className="text-[1rem] text-[#204FA2]">Argocoin Unveiled</p>
              A Revolutionary Native <br />
              Cryptocurrency
            </h1>
            <p className="text-[1rem] text-[#495167] font-ubuntu font-light font-weight-300">
              Argocoin (AGC) is not just a cryptocurrency; it's the linchpin of
              Devolved AI's mission to decentralize the future of Artificial
              Intelligence. As the proprietary digital currency on our layer 1
              blockchain
            </p>
            <p className="text-[1rem] text-[#495167] font-ubuntu font-light font-weight-300">
              AGC stands at the forefront of a new digital economy - set for
              launch to empower community-driven innovation and governance.
            </p>
            <Button
              title="WHITEPAPER"
      ...
      <section className="w-full my-10 md:mt-20 md:mb-0 items-center 3xl:container">
        <div className="flex flex-col-reverse items-center lg:flex-row justify-around lg:px-4 xl:px-8 md:mx-16 lg:mb-20 relative">
          <div className="flex flex-col px-5 md:mt-16 gap-5 xl:ms-20">
            ...
            <p className="text-[1rem] text-[#495167] font-ubuntu font-light font-weight-300">
              Though AGC is yet to be released, the anticipation is high for the
              multitude of ways users will be able to earn AGC. From validating
              network transactions to contributing valuable data for AI
              training, our Proof of Value (PoV) protocol is designed to reward
              every valuable action within the ecosystem.
            </p>
          </div>
          <Image
            src={Image2}
      ...
      <section className="w-full my-10 md:mt-20 md:mb-0 items-center 3xl:container">
        <div className="flex flex-col-reverse items-center lg:flex-row justify-around lg:px-4 xl:px-8 md:mx-16 lg:mb-20 relative">
          <div className="flex flex-col px-5 md:mt-16 gap-5 xl:ms-20">
            ...
            <p className="text-[1rem] text-[#495167] font-ubuntu font-light font-weight-300">
              The economic model behind AGC balances new token creation with a
              deflationary mechanism to ensure a stable and growing ecosystem.
              The utility of AGC will go beyond transactional use; it's the key
              to accessing enhanced AI services, participating in the ecosystem,
              and incentivizing growth and innovation.
            </p>
          </div>
        ...
        >
          ...
          <div className="fw-full max-w-xl text-center">
            ...
            <p className="text-[0.75rem] text-[#495167] font-ubuntu font-light font-weight-300">
              Join us on the ground floor of this revolutionary project. By
              becoming an early AGC holder, you not only stand to benefit from
              the ecosystem's growth but also become part of a movement to
              democratize AI, contributing to a platform that is truly
      ...
      <div className="h-50 bg-gradient-to-r from-gray-300 via-transparent to-gray-100">
        ...
        <section className="w-full my-10 md:mt-20 md:mb-0 items-center 3xl:container">
          <div className="flex flex-col-reverse items-center lg:flex-row justify-around lg:px-4 xl:px-8 md:mx-16 lg:mb-20 relative">
            ...
            <div className="flex flex-col px-5 md:mt-16 gap-5 xl:ms-20">
              ...
              <p className="text-[1rem] text-[#495167] font-ubuntu font-light font-weight-300">
                The journey doesn't end with the release of AGC. We have a
                roadmap that includes expanding into modules like computer
                vision and predictive analytics, creating a comprehensive suite
                of AI tools governed by AGC holders - ensuring a continuously
                evolving and advancing ecosystem.
              </p>
            </div>
          </div>
          <style jsx>
        ...
        <section className="w-full my-10 md:mt-20 md:mb-0 items-center 3xl:container">
          <div className="flex flex-col-reverse items-center lg:flex-row justify-around lg:px-4 xl:px-8 md:mx-16 lg:mb-20 relative">
            <div className="flex flex-col px-5 md:mt-16 gap-5 xl:ms-20">
              ...
              <p className="text-[1rem] text-[#495167] font-ubuntu font-light font-weight-300">
                We commit to the highest standards of security and economic
                resilience. The launch will be accompanied by strategies to
                prevent market manipulation and ensure a fair distribution,
                while also prioritizing the stability and long-term viability of
                AGC.
              </p>
            </div>
            <Image
        ...
        <section className="w-full my-10 md:mt-20 md:mb-0 items-center 3xl:container">
          <div className="flex flex-col-reverse items-center lg:flex-row justify-around lg:px-4 xl:px-8 md:mx-16 lg:mb-20 relative">
            ...
            <div className="flex flex-col px-5 md:mt-16 gap-5 xl:ms-20">
              <h1 className="text-[2.75rem] text-[#192033] font-ubuntu font-black font-weight-700">
                <p className="text-[1rem] text-[#204FA2]">Take Action</p>
                Your Pathway to Being a Part of the AI Evolution
              </h1>
              <p className="text-[1rem] text-[#495167] font-ubuntu font-light font-weight-300">
                Argocoin is not just currency; it's a stake in the future of AI.
      ...
      <section className="rounded-2xl shadow-lg flex flex-col items-center justify-center my-10 gap-5">
        <div
          className="flex flex-col gap-10 p-10 items-center justify-center w-[50rem]"
          style={{
        ...
        >
          <h1
            className="text-[#192033] text-start text-lg"
            style={{
              textAlign: "center",
              fontSize: "2rem",
              fontStyle: "normal",
