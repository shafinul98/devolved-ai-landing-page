    ...
    <main className="flex min-h-screen overflow-x-hidden flex-col items-center justify-between px-0 py-0 md:p-0">
      ...
      <section className="w-full my-10 md:mt-20 md:mb-0 items-center 3xl:container">
        <div className="flex flex-col-reverse items-center lg:flex-row justify-around lg:px-4 xl:px-8 md:mx-16 lg:mb-20 relative">
          ...
          <div
            className="flex flex-col px-5 md:mt-16 gap-5 xl:ms-20"
            style={{ maxWidth: "45.25rem" }}
          >
            ...
            <div>
              ...
              >
                We are more than just a platform; we are a movement aimed at
                redefining the relationship between AI and humanity. By using a
                decentralized approach, we ensure that our AI ecosystem is
                transparent, secure, and most importantly, governed by you.
              </motion.p>
              ...
              <AnimatePresence>
                {showSecondParagraph && (
                  ...
                  >
                    Our mission is to create an AI that is powered by the
                    people, for the people, ensuring shared prosperity and
                    ethical development. Be a part of this revolutionary
                    journey.
                  </motion.p>
                )}
              </AnimatePresence>
              <button
                className="bg-[#A9A3B2] text-[#fff] font-medium leading-normal rounded-[0.3125rem] w-full md:w-[10rem] md:h-[3.125rem] mt-5"
      ...
      <section className="flex flex-col rounded-[1rem] shadow-md m-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 3xl:container p-10">
            {/* Community Governed */}
            <div
              className="p-6 md:p-8 rounded-[1.24rem] bg-white hover:shadow-lg transition-all duration-300"
            ...
            >
              ...
              <p className="text-[1.125rem] text-[#495167] font-light leading-[1.875rem] mt-2">
                Have a say in the evolution of Devolved AI. Use your Argocoin to
                vote on proposals and guide the trajectory of our decentralized
                ecosystem.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-[1.125rem] text-[#495167] font-light leading-[1.875rem] mt-2">
                Engage, contribute, and be rewarded. Our Proof of Value Protocol
                incentivizes your valuable input, offering Argocoin as a reward
            ...
            >
              ...
              <p className="text-[1.125rem] text-[#495167] font-light leading-[1.875rem] mt-2">
                Experience a new level of transparency and security with our
                layer 1 blockchain. Our decentralized foundation ensures the
                integrity and openness of all actions on the platform.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full my-10 md:mt-20 md:mb-0 3xl:container">
        ...
        >
          ...
          <div
            ...
            style={{ maxWidth: "67.8125rem" }}
          >
            <h1 className="text-[3.75rem] text-[#192033] font-bold leading-normal">
              Argocoin: The Essence of Community
            </h1>
            <p className="text-[1.375rem] text-[#495167] font-light leading-[1.875rem]">
              Argocoin (AGC) is your digital passport to Devolved AI's
              ecosystem. It's not just a digital asset; <br />
              it's your voting ticket, your reward, and your stake in the
              community.
            </p>
      ...
      <section className="w-full my-10 md:mt-20 md:mb-0 items-center 3xl:container">
        <div className="flex flex-col-reverse items-center lg:flex-row justify-around lg:px-4 xl:px-8 md:mx-16 lg:mb-20 relative">
          <div className="flex flex-col px-5 md:mt-16 gap-5 xl:ms-20">
            ...
            <p className="text-[1.375rem] text-[#495167] font-light leading-[1.875rem]">
              Starting with Natural Language Processing, we are setting the
              stage for future innovations in Artificial General Intelligence,
              computer vision, predictive analytics, and more.
            </p>
      ...
      <section className="w-full my-10 md:mt-20 md:mb-0 items-center 3xl:container">
        <div className="flex flex-col-reverse items-center lg:flex-row justify-around lg:px-4 xl:px-8 md:mx-16 lg:mb-20 relative">
          ...
          <div className="flex flex-col px-5 md:mt-16 gap-5 xl:ms-20">
            ...
            <p className="text-[1.375rem] text-[#495167] font-light leading-[1.875rem]">
              As an early adopter, you have the unique opportunity to shape
              Devolved AI's future. Your governance will directly impact our
              development roadmap and platform features.
            </p>
            <div className="justify-center">
      ...
      <section className="rounded-2xl shadow-lg flex flex-col items-center justify-center my-10 gap-5">
        <div
          className="flex flex-col gap-10 p-10 items-center justify-center w-[66.875rem] h-[25.625rem]"
          style={{
      ...
      <section className="flex flex-col mt-12 md:px-10 md:gap-5 lg:gap-[5rem] lg:w-full lg:px-[3.5rem] xl:px-28 2xl:pl-[7.5rem] 3xl:container md:flex-row lg:justify-center mb-[3.75rem]">
        <div className="flex flex-col items-center py-[1.18675rem] md:py-0 md:items-start gap-[0.81rem] md:gap-3 ">
          <p className="text-[1rem] md:text-[1rem] leading-[1.25rem] text-center md:text-start font-normal text-[#323131]">
            ¹Devolved AI invites new users to earn $50 in AGC upon successful
            verification, plus an additional $50 for each active referral. The
            commencement of rewards is subject to the market cap's ability to
            feasibly sustain disbursements. Devolved AI retains the discretion
            to alter or discontinue the promotion in response to market and
            regulatory conditions. Offer activation, modifications, and
            eligibility are contingent on user engagement levels and market
            capitalization and are void where prohibited.
          </p>
        </div>
      </section>
