...
const SharingStage = () => {
  ...
  return (
    <div className="flex flex-col justify-center xl:flex-row gap-10 m-5">
      <div
        className="flex flex-col xl:w-full/2 h-auto gap-2 items-center mt-5 justify-center bg-white/70 backdrop-blur-md p-4 rounded-[1rem]"
